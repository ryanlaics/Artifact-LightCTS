...
parser.add_argument('--nhid',type=int,default=48,help='embedding size')
...
parser.add_argument('--cts_data',type=str,default='../../../data/METR-LA', help='data path')
parser.add_argument('--adj_mx',type=str,default='../../../data/METR-LA/adj_mx_metr_la.pkl', help='adj data path')
